...
public class WallJumpAgent : Agent
{
   ...
   // public GameObject goal;
    ...
    string m_NoObstacleBehaviorName = "SmallObstacleJump";
    string m_SmallObstacleBehaviorName = "SmallObstacleJump";
    string m_BigObstacleBehaviorName = "BigObstacleJump";
    ...
    public override void Initialize()
    {
        ...
        m_EnemyBlockRb = enemyBlock.GetComponent<Rigidbody>();
       ...
       /* var modelOverrider = GetComponent<ModelOverrider>();
        ...
        {
            noWallBrain = modelOverrider.GetModelForBehaviorName(m_NoObstacleBehaviorName);
            m_NoObstacleBehaviorName = ModelOverrider.GetOverrideBehaviorName(m_NoObstacleBehaviorName);

            smallWallBrain = modelOverrider.GetModelForBehaviorName(m_SmallObstacleBehaviorName);
            m_SmallObstacleBehaviorName = ModelOverrider.GetOverrideBehaviorName(m_SmallObstacleBehaviorName);

            bigWallBrain = modelOverrider.GetModelForBehaviorName(m_BigObstacleBehaviorName);
            m_BigObstacleBehaviorName = ModelOverrider.GetOverrideBehaviorName(m_BigObstacleBehaviorName);
        }*/
    }
   ...
   /* IEnumerator GoalScoredSwapGroundMaterial(Material mat, float time)
    ...
    public void MoveAgent(float[] act)
    {
       ...
       /* if (dirToGoForwardAction == 1)
        ...
        m_AgentRb.AddForce(dirToGo * m_Wall*JumpSettings.agentRunSpeed,
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        if ((!Physics.Raycast(m_AgentRb.position, Vector3.down, 20))
            || (!Physics.Raycast(m_EnemyBlockRb.position, Vector3.down, 20)))
        {
            SetReward(-1f);
            EndEpisode();
            ResetBlock(m_EnemyBlockRb);
            /*StartCoroutine(
    ...
    void ConfigureAgent(int config)
    {
       /* var localScale = wall.transform.localScale;
        if (config == 0)
        {
            ...
            SetModel(m_NoObstacleBehaviorName, noWallBrain);
        }
        else if (config == 1)
        {
            localScale = new Vector3(
                ...
                localScale.z);
            wall.transform.localScale = localScale;
            SetModel(m_SmallObstacleBehaviorName, smallWallBrain);
        }
        else
        {
            ...
            localScale = new Vector3(
                ...
                localScale.z);
            wall.transform.localScale = localScale;
            SetModel(m_BigObstacleBehaviorName, bigWallBrain);
        }*/
    }
}
